            ...
            <div className="flex flex-col items-center h-full gap-8">
              ...
              <div className="flex flex-col w-full gap-4 text-5xl ">
                ...
                <Link to={`/posts/profile/${perfil?.username}`}>
                  ...
                  <Button className="justify-start w-full gap-4 p-1 pl-3 text-lg font-bold text-white transition-all duration-200 bg-transparent rounded-full itms-center maxflex h-fit pr-7 hover:bg-rebeccapurple">
                    <UserCircleIcon className="w-8 h-8 mr-1 text-biancapurple" />{" "}
                    Profile
                  </Button>
                </Link>
