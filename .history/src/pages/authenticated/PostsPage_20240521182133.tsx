...
function Header() {
  return (
    <div className="fixed justify-center top-0 flex w-full h-8 bg-black border-b-[1px] border-b-gray-500 sm:hidden ">
      <ArrowLeftIcon className="fixed w-6 h-6 left-6"></ArrowLeftIcon>
      <h1>Post</h1>
    </div>
  );
}
